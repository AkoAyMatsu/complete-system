<?php 
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (isset($requestData['checkout_id'])) {
            ...
            $deleteCheckoutOrderQuery = "DELETE FROM " . TABLE_CHECKOUT_ORDER . " WHERE checkout_id = '$checkoutId' AND user_id = '$user_id'";
            ...
            if (mysqli_query($conn, $deleteCheckoutOrderQuery)) {
                ...
                $deleteCheckoutQuery = "DELETE FROM " . TABLE_CHECKOUT . " WHERE checkout_id = '$checkoutId' AND user_id = '$user_id'";
        ...
        // Check if order_id is present in the decoded data
        if (isset($requestData['order_id'])) {
            ...
            $deleteOrderQuery = "DELETE FROM " . TABLE_CUSTOMER_ORDER . " WHERE order_id = '$orderId' AND user_id = '$user_id'";
