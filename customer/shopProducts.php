...
<section>
    <div class="container-fluid p-5 mt-1">
        ...
        ?>  
            <div class="container-fluid bg-primary-subtle w-100 h-100 d-md-inline-flex d-sm-block  border-3 rounded-3 text-sm-center text-center product--container">
                
                <div class="p-2 img--container">
                    <img src="<?php echo '../'. $product['product_img']?>" alt="" class="p-2 img-fluid gallon--image"> <!--Image ng product-->
                </div>
