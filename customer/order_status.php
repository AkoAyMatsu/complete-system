    ...
    <section>
        <div class="container-fluid pt-5 h-100 w-100 mt-1 table--container" id="orderHistory">
            <ul class="nav nav-tabs dash--tabs">
                <li class="nav-item title--place d-flex">
                    <a href="cart.php" class="nav-link fs-6 text-bg-info text-center dash--title">Cart Items</a>
                    <a href="order_status.php" class="nav-link fs-6 text-bg-warning text-center dash--title">Order Status</a>
                </li>
            </ul>
        </div>
        ...
        <div class="container-fluid mb-5">
            <ul class="nav nav-tabs row-cols-5">
                <li class="nav-item">
                    <a class="nav-link active text-bg-danger" data-bs-toggle="tab" href="#toPay">To Pay</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-bg-primary" data-bs-toggle="tab" href="#toShip">To Ship</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-bg-info" data-bs-toggle="tab" href="#toReceive">To Receive</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-bg-success" data-bs-toggle="tab" href="#Completed">Completed</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-bg-secondary" data-bs-toggle="tab" href="#Cancelled">Cancelled</a>
                </li>
            ...
            <div class="tab-content">
                ...
                <div id="toShip" class="tab-pane">
                    <div class="container-fluid border border-3 bg-primary-light-subtle rounded-bottom-1 border-gray p-4">
                        <div id="toShipContainer" class="toShipContainer">
                            <!--<img src="../rounded-gallon.jpeg" alt="" width="160" height="175" class="rounded-2 border border-1 border-black my-3 mx-3">
                                <div class="h6 fw-bold p-3 mt-3 py-1 h-25 w-100 text-end">
                                    In transit
                                    <div class="h6 text-start mt-3 fw-bold">18L Rounded Gallon Water</div>
                                    ...
                                    <div class="h6 mt-0 py-0 text-danger">
                                        Php <span class="h6 text-danger">3,000.00</span>
                                    </div>
                                </div>-->
                        </div>
                        
                        <!--<br>-->
                        <div class="toShipPricesContainer" id="toShipPricesContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 text-bg-light border border-2 border-black rounded-1 d-flex h-50">
                                ...
                                <div class="container d-flex justify-content-end mt-2">
                                    ...
                                    <div class="h6 text-danger px-1">3,000.00</div>
                                </div> 
                            </div>-->
                        </div>

                        <div class="toShipDateContainer" id="toShipDateContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 d-flex mt-3 h-50 border-bottom border-3 justify-content-between">
                        ...
                        <div class="receiveDetailsContainer" id="receiveDetailsContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 mt-3 d-flex h-50 justify-content-between">
                                <div>
                        ...
                        <div id="noToShipContainer" class="noToShipContainer">
                                <!--<div class="container-fluid w-100 p-2 text-bg-light rounded-1 d-flex mt-0 h-50 justify-content-center">
                                    <div class="h4 mt-1 mx-3 px-0 fw-bold text-center">
                                        <img src="truck-icon.png" alt="" width=200 height=200 class="mt-3">
                                        <div class="py-2 mt-3">IN TRANSIT ORDER</div>
                                    </div> 
                                </div>-->
                        </div>
                ...
                <div id="toReceive" class="tab-pane">
                    <div class="container-fluid border border-3 bg-primary-light-subtle rounded-bottom-1 border-gray p-4">
                        <div id="toReceiveContainer" class="toReceiveContainer">
                        ...
                        <div class="toReceivePricesContainer" id="toReceivePricesContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 text-bg-light border border-2 border-black rounded-1 d-flex h-50">
                                <div class="h6 mt-2 w-50 mx-3 px-0">1
                                    <span class="h6">item/s</span>
                                </div>
                        ...
                        <div class="toReceiveDateContainer" id="toReceiveDateContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 d-flex mt-3 h-50 border-bottom border-3 justify-content-between">
                                <div class="h6 mt-2 w-50 mx-2 px-0 text-primary d-flex">
                                    <div class="bi bi-truck fs-3"></div>
                        ...
                        <div class="toReceiveInfoContainer" id="toReceiveInfoContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 mt-3 d-flex h-50 justify-content-between">
                                <div>
                                    <div class="h6">Receive products and</div>
                                    <div class="h6">make payment by 
                            ...
                            <div id="receivedItemContainer" class="receivedItemContainer">
                                <!--<div class="container-fluid w-100 p-2 text-bg-light rounded-1 d-flex mt-0 h-50 justify-content-center">
                                    <div class="h4 mt-1 mx-3 px-0 fw-bold text-center">
                                        <img src="receive-icon.png" alt="" width=150 height=150 class="mt-3">
                                        <div class="py-2 mt-3">ORDER RECEIVED</div>
                                    </div> 
                                </div>-->                                
                            </div> 
                    </div>
                ...
                <div id="Completed" class="tab-pane">
                    <div class="container-fluid border border-3 bg-primary-light-subtle rounded-bottom-1 border-gray p-4">
                        <div id="completedContainer" class="completedContainer">
                            <!--<img src="../rounded-gallon.jpeg" alt="" width="160" height="175" class="rounded-2 border border-1 border-black my-3 mx-3">
                                <div class="h6 fw-bold p-3 mt-3 py-1 h-25 w-100 text-end">
                                    Completed
                                    <div class="h6 text-start mt-3 fw-bold">18L Rounded Gallon Water</div>
                        ...
                        <div class="completedPricesContainer" id="completedPricesContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 text-bg-light border border-2 border-black rounded-1 d-flex h-50">
                                <div class="h6 mt-2 w-50 mx-3 px-0">1
                                    <span class="h6">item/s</span>
                                </div>
                        ...
                        <div class="dateCompletedContainer" id="dateCompletedContainer">
                            <!--<div class="container-sm w-70 ms-0 p-2 d-flex mt-3 h-50 border-bottom border-3 justify-content-between">
                                <div class="h6 mt-2 w-50 mx-2 px-0 text-primary d-flex">
                                    <div class="bi bi-truck fs-3"></div>
                        ...
                        <div id="completedOrderDisplay" class="completedOrderDisplay">
                            <!--<div class="container-fluid w-100 p-2 text-bg-light rounded-1 d-flex mt-0 h-50 justify-content-center">
                                <div class="h4 mt-1 mx-3 px-0 fw-bold text-center">
                                    <img src="completed-icon.png" alt="" width=150 height=150 class="mt-3">
                                    <div class="py-2 mt-3">COMPLETED ORDERS</div>
                                </div> 
                            </div>-->
                        </div>
            ...
            <div id="Cancelled" class="tab-pane">
                <div class="container-fluid border border-3 bg-primary-light-subtle rounded-bottom-1 border-gray p-4">
                    ...
                    <div id="cancelledOrderDisplay" class="cancelledOrderDisplay">
                            <!--<div class="container-fluid w-100 p-2 text-bg-light rounded-1 d-flex mt-0 h-50 justify-content-center">
                                <div class="h4 mt-1 mx-3 px-0 fw-bold text-center">
                                    <img src="cancel-icon.png" alt="" width=150 height=150 class="mt-3">
                                    <div class="py-2 mt-3">CANCELLED ORDERS</div>
                                </div> 
                            </div>-->
                    </div>
                </div>
